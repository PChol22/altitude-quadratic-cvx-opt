...
def rec(variables, variable_index, user_input):
  ...
  free_variables = variables[:variable_index]

  if variable["i"] == None:
    is_free_on_y = any(map(lambda v: v["j"] == variable["j"] and v["i"] != None, free_variables))
    is_free_on_x = any(map(lambda v: v["j"] != variable["j"] and v["i"] == None, free_variables))
    ...
    for p in possibilities:
      ...
      if rec(free_variables, variable_index - 1, user_input):
        #print("OK sector", p)
        return True
  ...
  if variable["j"] == None:
    is_free_on_y = any(map(lambda v: v["i"] != variable["i"] and v["j"] == None, free_variables))
    is_free_on_x = any(map(lambda v: v["i"] == variable["i"] and v["j"] != None, free_variables))
    ...
    is_free_on_y = any(map(lambda v: v["i"] != variable["i"] and v["j"] == variable["j"], free_variables))
    is_free_on_x = any(map(lambda v: v["i"] == variable["i"] and v["j"] != variable["j"], free_variables))
